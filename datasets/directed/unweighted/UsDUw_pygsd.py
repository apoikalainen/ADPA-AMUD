...
class UsDUwPyGSDDataset(NodeDataset):
    ...
    def __init__(self, args, name="coraml", root="./datasets/directed/unweighted/", k=2,
        ...
        if self.name in ("proteins", "coauthor-cs", "coauthor-physic", "pubmed", "mooc", "texas", "wisconsin", "squirrel",
        ...
        if self.name in ("roman", "rating", "minesweeper", "tolokers", "question", "squirrelfilterdir", "chameleonfilterdir", "snap", "actor", "texas", "mooc", "wisconsin"):
    ...
    def raw_file_paths(self):
        ...
        elif self.name in ("amazon-computers", "amazon-photo", "pubmed", "coauthor-cs", "coauthor-physic", "minesweeper", "tolokers", "roman", "rating", "question", "squirrelfilterdir", "chameleonfilterdir", "actor", "texas", "mooc", "wisconsin"):
            filename = dataset_name[self.name]
            return [osp.join(self.raw_dir, filename)]
    ...
    def process(self):
        ...
        elif self.name in ("minesweeper", "tolokers", "roman", "rating", "question", "squirrelfilterdir", "chameleonfilterdir", "actor", "texas", "mooc", "wisconsin"):
            with np.load(self.raw_file_paths[0], allow_pickle=True) as loader:
                loader = dict(loader)
    ...
    def generate_split(self):
        have_split = ['roman', 'rating', 'minesweeper', 'tolokers', 'question', "squirrelfilterdir", "chameleonfilterdir", "squirrelfilter", "chameleonfilter", "snap", "actor", "texas", "mooc", "wisconsin"]
